...
<audio src={"https://peer2p.online/background.mp3"} autoPlay style={{display:"none"}}/>
   ...
   <p className="text-[7.5vw] font-[900] ">DEPRECATED</p>
   <p className="font-[500] text-[1.4161vw] text-[#d7d7d7]">This project is deprecated. There's nothing to see.</p>
   </div>
   <div className="font-[600] hover:cursor-pointer text-[2.5vw] flex flex-row items-center justify-center gap-[1em] rounded-[15px] p-[15px_30px]" style={{background:"linear-gradient(#171921, #0b0a11)"}}>
